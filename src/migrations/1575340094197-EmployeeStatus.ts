...
export class EmployeeStatus1575340094197 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `employees` ADD `status` varchar(50) NOT NULL DEFAULT \'REGULER\'', undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `employees` DROP COLUMN `status`', undefined);
