...
export class InitDB1578966978240 implements MigrationInterface {
    name = 'InitDB1578966978240';
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('CREATE TABLE `accounts` (`id` varchar(255) NOT NULL, `created_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `first_name` varchar(255) NOT NULL, `last_name` varchar(255) NULL, `avatar` varchar(255) NULL, `username` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `token_reset_password` varchar(255) NULL, `is_disabled` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX `IDX_477e3187cedfb5a3ac121e899c` (`username`), UNIQUE INDEX `IDX_ee66de6cdc53993296d1ceb8aa` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB', undefined);
